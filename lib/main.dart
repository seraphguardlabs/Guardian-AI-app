...
// flutter_gemma import removed as it is no longer used in this file
...
// gemma_content_analyzer import removed as it is no longer used in this file
            ...
            builder: (_) => MultiProvider(
              providers: [
                ...
                ChangeNotifierProvider(
                  create: (_) => GamifiedPermissionService(),
                ),
              ],
...
void onStart(ServiceInstance service) async {
  ...
  // Background monitoring replaced by foreground ScreenMonitoringService
  // to prevent isolate resource contention and OutOfMemory crashes.
  AppLogger.log('[BG] Background service active');
}
