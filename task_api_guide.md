...
Children authenticate using their child hash and password via:
- **Headers**: `X-Child-Hash` and `X-Password`
- **JSON Body**: `{"child_hash": "...", "password": "..."}`
...
| `due_date` | string (ISO 8601) | No | Optional due date in ISO format |
...
```json
{
    ...
    "task": {
        ...
        "description": "Finish your math and science homework before dinner",
        "is_completed": false,
        "due_date": "2026-01-20T18:00:00+00:00",
